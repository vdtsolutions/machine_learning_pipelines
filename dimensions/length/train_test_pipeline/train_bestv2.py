...
# ================= AXIAL INDEX SPAN (PHYSICS FEATURE) =================
...
# ================= FEATURES (NO INDEX LEAKAGE) =================
# FEATURES = [
#     "pred_length",
#     "axial_index_span",   # <<< NEW KEY FEATURE
#
#     # submatrix morphology
...
# ================= OPTIONAL SAFETY GATING (RECOMMENDED) =================
# Do not ML-correct tiny defects
tiny_mask = test_df["pred_length"] < 10
test_df.loc[tiny_mask, "pred_corrected"] = test_df.loc[tiny_mask, "pred_length"]
...
out_path = r"D:\Anubhav\machine_learning_pipelines\dimensions\length\train_test_pipeline\TEST_PREDICTIONS_V2_AXIAL_SPAN.csv"
